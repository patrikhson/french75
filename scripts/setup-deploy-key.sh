...
echo ""
echo "Copying public key to $VM01 ..."
scp "${KEY_PATH}.pub" "$VM01:/tmp/french75_deploy.pub"

echo "Installing public key for deploy user (sudo required) ..."
ssh -t "$VM01" "sudo mkdir -p /home/deploy/.ssh && sudo tee -a /home/deploy/.ssh/authorized_keys < /tmp/french75_deploy.pub > /dev/null && sudo chmod 700 /home/deploy/.ssh && sudo chmod 600 /home/deploy/.ssh/authorized_keys && sudo chown -R deploy:deploy /home/deploy/.ssh && rm /tmp/french75_deploy.pub"
